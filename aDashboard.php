                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <?php  
                                                include ("condb.php");
                                                  ...
                                                  $sql = "SELECT * FROM studenttbl WHERE Status = '0' ORDER BY SID";  
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php  
                                                include ("condb.php");
                                                  ...
                                                  $sql = "SELECT * FROM tutortbl WHERE Approve = '0' ORDER BY TID";  
                                                  $result = mysqli_query($cn, $sql);
                                                  $row = mysqli_num_rows($result);
                                                  

                                                echo '<div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        ...
                                        <div class="col-auto">
                                            <i class="far fa-handshake fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
